...
public class MyBatisContactsRepository implements ContactsRepository{
    @Override
    public void addNewContact(Person person) throws RepositoryException {
        throw new RepositoryException("Method not implemented yet in MyBatisContactsRepository class");
    }
